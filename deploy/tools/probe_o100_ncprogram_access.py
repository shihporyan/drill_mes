...
# 5/3: M13-M18 NcProgram share perms opened.
# 5/8: remaining M01-M12 opened — default now covers all 18 takeuchi machines.
DEFAULT_MACHINES = ",".join("M{:02d}".format(i) for i in range(1, 19))
